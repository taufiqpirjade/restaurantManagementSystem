angular.module('restonza').controller('UpdateOrderController', function ($scope,$filter,$http,$route,RESTONZACONSTANTS/* $scope, $location, $http */) {
...
var url = RESTONZACONSTANTS.url + "/getDishes2";
